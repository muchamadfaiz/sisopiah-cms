...
export const DETAIL_BILL = () => {
  ...
  const onFinish = (values) => {
    ...
    const payload = {
      ...
      paid_at: values.paid_at ? values.paid_at.format("YYYY-MM-DD") : null,
    };
          ...
          <Card>
            ...
            >
              ...
              <Form.Item label="Nama" name="name">
                <Select placeholder="Pilih Murid" options={subcategories} />
              </Form.Item>
              ...
              <Form.Item label="Jumlah" name="amount">
                <Input />
              </Form.Item>
              ...
              <Form.Item label="Tanggal bayar" name="paid_at">
                {/* <Input /> */}
                <DatePicker format="YYYY-MM-DD" style={{ width: "100%" }} />
              </Form.Item>
              ...
              <Form.Item label="Link Pembayaran" name="payment_link">
                <Input />
              </Form.Item>
